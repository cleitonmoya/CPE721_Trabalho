% Classificação binária - Gradiente Descendente - K-fold
...
% Hiperparâmetros
p1 = [2, 3, 4, 5, 6, 7, 8];     % número de neurônios na cadama oculta
p2 = [0.05, 0.1, 0.2];          % taxa de aprendizado
...
for i = 1:length(p1)
    ...
    for j = 1:length(p2)
        ...
        for k=1:K
            ...
            % Parâmetros específicos do Gradiente Descendente
            net.trainParam.lr = p2;
